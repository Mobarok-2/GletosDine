                    ...
                    <div class="container my-5 py-5">
                        <div class="row align-items-center g-5">
                            <div class="col-lg-6 text-center text-lg-start">
                                <h1 class="display-3 text-white animated slideInLeft">Enjoy Our<br>Delicious <br> Dessert</h1>
                            ...
                            <div class="col-lg-6 text-center text-lg-end overflow-hidden">
                                <img class="img-fluid" src="img/3775558_1988955-modified.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="row g-3">
                            <div class="col-6 text-start">
                                <img class="img-fluid rounded w-100 wow zoomIn" data-wow-delay="0.1s" src="img/9553.jpg">
                            </div>
                            <div class="col-6 text-start">
                            ...
                            <div class="col-6 text-end">
                                <img class="img-fluid rounded w-100 wow zoomIn" data-wow-delay="0.7s" src="img/9587749_38276.jpg">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <h5 class="section-title ff-secondary text-start text-primary fw-normal">About Us</h5>
                        <h1 class="mb-4">Welcome to <i class="fa fa-utensils text-primary me-2"></i>Gelato's Den</h1>
                ...
                <div class="tab-class text-center wow fadeInUp" data-wow-delay="0.1s">
                    <ul class="nav nav-pills d-inline-flex justify-content-center border-bottom mb-5">
                        ...
                        <li class="nav-item">
                            <a class="d-flex align-items-center text-start mx-3 me-0 pb-3" data-bs-toggle="pill" href="#tab-4">
                                <i class="fa fa-utensils fa-2x text-primary"></i>
                                <div class="ps-3">
                                    <small class="text-body">Sweetest</small>
                    ...
                    <div class="tab-content">
                      ...
                      <div id="tab-2" class="tab-pane fade show p-0">
                        ...
                        </div> <div id="tab-3" class="tab-pane fade show p-0">
                            <div class="row g-4">
                        ...
                        <div id="tab-4" class="tab-pane fade show p-0">
                            ...
                            <?php foreach($meals_4 as $meal_4) : ?>
                                <div class="col-lg-6 p-3">
                                    <div class="d-flex align-items-center">
                                        <img class="flex-shrink-0 img-fluid rounded" src="img/<?php echo $meal_4->image; ?>" alt="" style="width: 80px;">
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            <h5 class="d-flex justify-content-between border-bottom pb-2">
                    ...
                    <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <form method="POST" action="booking_table.php">
                            <div class="row g-3">
                                ...
                                <?php else :?>
                                        <p class="text-white">You Need To Login For Booking Table </p>
                                <?php endif; ?>

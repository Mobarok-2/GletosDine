...
?>
        ...
        <!-- Reservation Start -->
        <div class="container-xxl py-5 px-0 wow fadeInUp" data-wow-delay="0.1s" style="margin-left: 20%;">
            <div class="row g-0">
                <div class="col-md-6 bg-dark d-flex align-items-center">
                    <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                        <h5 class="section-title ff-secondary text-start text-primary fw-normal">Write Review</h5>
                        <h4 class="text-white mb-4">Share Your Experince with us</h4>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <textarea name="review" class="form-control" placeholder="SSubmit Reviewt" id="message" style="height: 100px"></textarea>
